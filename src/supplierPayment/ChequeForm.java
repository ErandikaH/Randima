...
public class ChequeForm extends javax.swing.JDialog {
    ...
    public ChequeForm(java.awt.Frame parent, boolean modal) {
        ...
        ChequeUtilities.viewCheque(jTable1, "select * from SupplierChequePayment");
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(223, 223, 249));
        ...
        jLabel4.setFont(new java.awt.Font("Meiryo", 3, 24)); // NOI18N
        jLabel4.setText("Supplier Cheque Payment");
...
//        }
    ...
    private void nameTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nameTextActionPerformed
        ...
        if (!ValidationPayment.isValidBankName(name)) {
            validator.addWarning(nameText);
            nameText.setText("");
        } else {
    ...
    private void chequeNoTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chequeNoTextActionPerformed
        String chequeNo = chequeNoText.getText();
        if (!ValidationPayment.isValidChequeNo(chequeNo)) {
            validator.addWarning(chequeNoText);
            chequeNoText.setText("");
        } else {
    ...
    private void statusTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_statusTextActionPerformed
        ...
        if (!ValidationPayment.isValidStatus(status)) {
            validator.addWarning(statusText);
            statusText.setText("");
        } else {
