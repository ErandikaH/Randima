...
public class ChequeUtilities {
    ...
    public static int addCheque(Cheque cheque) throws SQLException{
        ...
        String sql = "INSERT INTO SupplierChequePayment (chequeNo,paymentId,bankName,chequeDate,status,chequeAmount) VALUES ('"+cheque.getChequeNo()+"','"+cheque.getPaymentId()+"','"+cheque.getBankName()+"','"+cheque.getChequeDate()+"',"+cheque.isStatus()+","+cheque.getChequeAmount()+")";
    ...
    public static int updateCheque(Cheque cheque) throws SQLException{
        ...
        String sql = "Update SupplierChequePayment SET paymentId='"+cheque.getPaymentId()+"', chequeDate = '"+cheque.getChequeDate()+"',bankName = '"+cheque.getBankName()+"',status ="+cheque.isStatus()+",chequeAmount = "+cheque.getChequeAmount()+" where chequeNo = '"+cheque.getChequeNo()+"'"; 
        int res = DBHandle.setData(DBCon.getConnection(), sql);
        return res;
    }
    ...
    public static int deleteCheque(Cheque cheque) throws SQLException{
        ...
        String sql = "Delete from SupplierChequePayment where chequeNo ='"+cheque.getChequeNo()+"'";
        int res = DBHandle.setData(DBCon.getConnection(), sql);
        return res;
    }
    ...
    public static Cheque searchCheque(String no) throws SQLException{
        ...
        String sql = "Select * from SupplierChequePayment where chequeNo = '"+no+"'";
